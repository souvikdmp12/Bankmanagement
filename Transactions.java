...
public class Transactions extends JFrame implements ActionListener {
    ...
    JButton deposit,withdrawl,ministatement,pinchange,fastcash,balanceenquiry,language,exit;
    String pinnumber;
    Transactions(String pinnumber){
        ...
        ministatement = new JButton("Mini Statemnt");
        ...
        language= new JButton("Language Change");
        language.setBounds(170,465,150,30);
        language.addActionListener(this);
        image.add( language);
        
        exit= new JButton("Exit");
        exit.setBounds(584,465,150,30);
